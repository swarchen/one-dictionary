        ...
        execute: function() {
            WordsService = (function () {
                function WordsService(_http) {
                    this._http = _http;
                    this._BaseUrl = "https://one-dictionary-cfcde.firebaseio.com/rest/words/";
                }
                WordsService.prototype.getWord = function (word) {
                    return this._http.get(this.getWordUrl(word))
                        .map(function (res) { return res.json(); });
                };
                WordsService.prototype.getWordUrl = function (word) {
